...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/spgenius/Movie_Recommender_System/blob/main/requirements.txt) file with the command `pip install -r requirements.txt`.
